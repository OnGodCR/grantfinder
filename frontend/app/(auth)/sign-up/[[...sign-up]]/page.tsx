      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-400">
            Get started with AI-powered grant discovery
          </p>
        </div>
        <div className="bg-slate-800 rounded-xl p-8 shadow-2xl border border-slate-700">
          <SignUp 
            ...
            redirectUrl="https://grantlytic.com/onboarding"
            signInUrl="https://grantlytic.com/sign-in"
            afterSignUpUrl="https://grantlytic.com/onboarding"
          />
        </div>
      </div>
    </div>
