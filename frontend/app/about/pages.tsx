  ...
  return (
    <div className="mx-auto max-w-6xl px-4 pt-16 pb-24">
      ...
      <section className="mt-16">
        ...
        <p className="mt-3 text-body">
          {BRAND} brings it all together—acting like a funding radar for universities.
        </p>
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          ...
          <Feature title="AI-Powered Summaries">
            Each grant is distilled into plain language with clear eligibility highlights.
          </Feature>
          <Feature title="Personalized Match Scores">
            Faculty and department profiles ensure the right grants find the right researchers.
          </Feature>
          ...
          <Feature title="Secure & Compliant">
            Built on public, verifiable data sources with privacy in mind.
          </Feature>
        </div>
      </section>
      ...
      <section className="mt-16">
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-4">
          <Value title="Trustworthy">
            Built on public, verifiable data sources.
          </Value>
          <Value title="Efficient">
            Every feature is designed to save hours of manual searching.
          </Value>
          <Value title="Collaborative">
            Faculty and administrators work together seamlessly.
          </Value>
          <Value title="Impact-Driven">
            Every grant won fuels new knowledge, innovation, and student opportunity.
          </Value>
        </div>
      </section>
      ...
      <section className="mt-16">
        <div className="rounded-3xl border border-mint/30 bg-gradient-to-br from-white/10 to-white/0 p-8 ring-1 ring-white/10">
          ...
          <p className="mt-3 text-body">
            We’re building more than a platform—we’re building a future where every university has
            the tools to maximize its research potential. Our vision is to become the trusted
            funding partner for institutions worldwide, empowering the next generation of
            discoveries.
          </p>
        </div>
      </section>
      ...
      <section className="mt-16 grid gap-6 md:grid-cols-[220px_1fr] items-start">
        <div className="rounded-3xl border border-white/10 bg-white/5 p-6 text-center">
          ...
          <div className="mt-1 text-sm text-body">
            Youth Researcher, University of Washington
          </div>
        ...
        <Card>
          ...
          <p className="mt-3 text-body">
            ...
            Washington, I saw first-hand the challenges faculty face in securing funding. Professors
            and PhD students spoke often about the inefficiency of grant discovery. That perspective—combined
            with my passion for AI—led me to create {BRAND}.
          </p>
          <p className="mt-3 text-body">
          ...
          <p className="mt-6 text-text font-medium">
            ✨ {BRAND}: Where universities meet opportunity.
          </p>
        </Card>
      </section>
